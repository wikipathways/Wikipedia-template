...
my $mimat = "http://www.mirbase.org/cgi-bin/mature.pl?mature_acc=";
...
#   				}
      		...
      		case "Mbm"
      			{
      			#print "system is miRBase mature sequence\n";
      			$xref =~ m/Mbm_(.+)/;
      			$id = $1;
      			$newlink = $mimat.$id." Go to miRBase";	
				$color = 'green';
      			}
      		case "Mb"
      			{
      			#print "system is miRBase sequence\n";
      			$xref =~ m/Mb_(.+)/;
      			$id = $1;
      			$newlink = $mimat.$id." Go to miRBase";	
				$color = 'green';
